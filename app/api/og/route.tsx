    ...
    (
      ...
      >
        ...
        >
          ...
          {isScreenCustom && screenTitle ? <h3 style={{ fontSize: '60px', marginTop: 2, fontWeight: 800, background: 'rgba(30.2%, 54.12%, 89.8%, 0.7)', backdropFilter: 'blur(16px)', padding: '10px', borderRadius: '10px' }}>{screenTitle}</h3> : null}
        </div>
